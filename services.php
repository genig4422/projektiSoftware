...
require_once 'header.php'; // This should define $conn (MySQLi connection)
                ...
                <div class="modal fade" id="addServiceModal" tabindex="-1" aria-labelledby="addServiceModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form method="POST" action="services.php<?php if ($car_id) echo '?car_id=' . htmlspecialchars($car_id); ?>">
